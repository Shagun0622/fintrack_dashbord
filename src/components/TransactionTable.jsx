    ...
    <div className="tbl-wrap">
      <table className="tbl">
        <thead>
          <tr>
            {COLS.map(c => (
              <th key={c.key} className={compact ? '' : 'sort'} onClick={compact ? undefined : () => handleSort(c.key)}>
              ...
              {role === 'admin' && !compact && (
                <td>
                  <div className="row-acts">
                    ...
                    <button className="act-btn del" onClick={() => window.confirm('Delete this transaction?') && deleteTransaction(txn.id)}>
